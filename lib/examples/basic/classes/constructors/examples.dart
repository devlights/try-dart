...
import 'package:try_dart/examples/basic/classes/constructors/required.dart';
import 'package:try_dart/examples/basic/classes/constructors/syntax_sugar.dart';
...
void build(ExampleMapping map) {
  ...
  map.add('basic_classes_constructors_syntax_sugar', syntaxSugar);
  map.add('basic_classes_constructors_required', withRequired);
}
